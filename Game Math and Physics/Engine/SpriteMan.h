...
class CSpriteManager{
  ...
  public:
    ...
    int GetSpriteWidth(const int n); ///< Get sprite width in pixels.
    int GetSpriteHeight(const int n); ///< Get sprite height in pixels.
    void GetSpriteSize(int& w, int& h, const int n); ///< Get sprite size in pixels.
}; //CSpriteManager