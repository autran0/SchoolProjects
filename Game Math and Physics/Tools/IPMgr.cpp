...
WSAEDESCRIPTION g_WSAErrorDescriptions[] = { ///< Winsock error strings for each error code.
  WSAEINTR,
...
IPManager::IPManager(char* address, int port){  
...
/// Send a UDP packet containing a message string.
/// \param message Message string to be sent in the packet
/// \param length Length of message string to be sent
/// \return TRUE if the packet sent correctly

BOOL IPManager::SendPacket(char* message, int length){ 
